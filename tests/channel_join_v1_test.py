...
def test_invalid_channel_id():
    clear_v1()
    user = auth_register_v1("j@email.com", "ABCDEF123", "Cal", "Watts")
...
def test_join_private_channel():
    owner = auth_register_v1("j@email.com", "ABCDEF123", "Cal", "Watts")
    user = auth_register_v1("k@email.com", "ABCDEF123", "Kim", "Smith")
